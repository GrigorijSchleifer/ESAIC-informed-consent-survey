...
technical_barchart <- survey_data %>% 
    select(c("Country where you work?", "Is it possible to obtain informed consent online via internet, in your routine setting?"))
...
technical_barchart %>%
    ...
    mutate(technical = fct_reorder(technical, )) %>% 
    ggplot(aes(x = country, fill = technical)) +
