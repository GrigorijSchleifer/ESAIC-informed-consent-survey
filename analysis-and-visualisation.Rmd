...
id_dilemma_tbl <- data.frame(Values = c(49, 234, 362, 29, 423, 193),
                             ...
                             prop_values = round(c(0.07596899, 0.36279070, 0.56124031, 0.04496124, 0.65581395, 0.29922481) * 100))
...
id_dilemma_tbl %>%
    ...
    theme(# axis.text.x = element_blank(),
          ...
          axis.title.x = element_blank(),
          rect = element_blank()) + 
    geom_text(aes(label = prop_values, y = Values), size = 3, position = position_stack(vjust = 0.5))
```
