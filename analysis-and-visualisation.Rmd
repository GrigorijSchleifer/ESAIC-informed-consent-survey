...
pandemic_adnustments <- data.frame(answer = c("I don´t know", 
                                        "No", 
                                        "Yes"),
                             value =  round((c(.2518703, 0.5610973, 0.1870324) * 100), 1))
```
...
future_consent <- data.frame(answer = c("In person",
                                        ...
                                        "Via telefone"),
                             value =  round((c(0.77910053, 0.07539683, 0.11640212, 0.02910053) * 100), 1))
```
```{r Technical ...}
